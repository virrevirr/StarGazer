    ...
    <div>
      ...
      <div className="ParentContainer topInfoContainer">
        ...
        <div className="location">
          {props.locationData.city + ", " + props.locationData.country}
        </div>

        <div className="beenAndWantButtons">
          <span>
            <button
              className="biggerButtonDesign disabled"
              title="Add to Profile!"
              onClick={visitedACB}
              disabled={props.locvisited}
            >
              I have been here
            </button>
            <button
              ...
              title="Add to Profile!"
              onClick={wantToGoACB}
              disabled={props.locgo}
            >
              I want to go here
            </button>{" "}
            {/* Lägg till class för att göra knapparna snygga */}
          </span>
        </div>
