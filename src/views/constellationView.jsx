...
function ConstellationView(props) {
  ...
  return (
    <div className="searchContainer">
      <div className="backToSearchButton">
        ...
        <button
          className="biggerButtonDesign"
          onClick={navigateToAllConstellationsACB}
        >
          Constellations
        </button>
      </div>
      ...
      <div className="iHaveSeenButton">
        ...
        <button
          ...
          onClick={haveSeenACB}
        >
          I have seen this in {props.location.city}
        </button>
      </div>
      ...
      <div className="constellationDetailsContainer">
        ...
        <div className="constellationImageContainer">
          <img
            src={
              starConstellations[props.currentConstellation[0].constellation]
            }
            height={"400"}
          />
        </div>
        ...
        <div className="starsIncludedContainer">
          ...
          <ul>{props.currentConstellation.map(starsInConstellationCB)}</ul>
        </div>
      </div>
  ...
  function starsInConstellationCB(star) {
    ...
    return <span key={star.name}>{star.name}</span>;
  }
}
